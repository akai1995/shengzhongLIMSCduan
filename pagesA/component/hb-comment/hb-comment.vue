<template>
	<view class="hb-comment">
		...
		<!-- 阅读数-end -->
		<!-- 阅读数下边那条线-start -->
		<view class="seg_line_box" v-if="false">
					...
					<view class="comment-main">
						...
						<view class="comment-main-top">
							...
							<view class="zan-box" @click="like(item.id)">
								<span :class="item.hasLike ? 'isLike' : 'notLike'">{{item.likeNumber == 0 ? '抢首赞' : item.likeNumber}}</span>
								<img style="width: 14px; height: 14px;"
								...
								<!-- <img style="width: 14px; height: 14px;" v-if="!islike"
									src="data:image/png;base64," />
						...
						<view class="comment-main-foot">
							<view class="foot-time">{{item.commentTime}}</view>
							<view class="foot-btn" @click="reply(item.userName,item.userName,item.id)">回复</view>
							...
							<view class="comment-sub-item" v-for="each in item.children">
								...
								<view class="comment-main">
									<view class="sub-comment-main-top">
										<view class="nick-name">{{each.userName}}</view>
										<view class="zan-box" @click="like(each.id)">
											<span :class="each.hasLike ? 'isLike' : 'notLike'">{{each.likeNumber == 0 ? '抢首赞' : each.likeNumber}}</span>
											<img style="width: 14px; height: 14px;"
												src="data:image/png;base64," />
											<!-- <img style="width: 14px; height: 14px;" v-if="!islike"
												src="data:image/png;base64," /> -->
									...
									<view class="comment-main-foot">
										<view class="foot-time">{{each.commentTime}}</view>
										<view class="foot-btn" @click="reply(item.userName,each.userName,item.id)">
											回复</view>
		...
		<view class="comment-none" v-else>
			暂无评论，<span @click="commentInput" style="color: #007AFF;">抢首发</span>
		</view>
		<!-- 无评论-end -->
		<!-- 新增评论-start -->
	...
	export default {
		...
		methods: {
			...
			add() {
				...
				this.newsComment.newsId = this.ncData.newsId
				this.newsComment.title = this.ncData.title
				this.newsComment.userId = this.$store.getters.userId
				this.newsComment.userName = this.$store.getters.name
				this.newsComment.avatarUrl = this.$store.getters.avatar
				this.newsComment.parentId = this.commentReq.pId
				this.newsComment.content = this.commentReq.content
				addNewsComment(this.newsComment).then(res=>{	
					if(res.code == 200){
						this.focus = false;
						this.submit = false;
			...
			//评论评价列表
			getCommentLists() {
				let newsId = this.ncData.newsId;
				commentList(newsId).then(res => {
			...
			like(commentId) {
				...
				commentLike(param).then(res=>{
					if(res.code == 200){
						uni.showToast({
							title:res.msg,
							icon:"none"
						})
						this.islike = res.data.isMem
						that.getCommentLists();
					}
				})
