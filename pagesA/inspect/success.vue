<template>
	<view>
		<ut-nav title="申请成功" border url="/pages/index/index"></ut-nav>
		<view class="ut-padding">
			...
			<view class="font">申请成功，</view>
			<view class="fontSmall">预计需要<text style="margin: 0 4rpx; color:rgba(0, 199, 119, 1)"> 6~15个工作日送达</text></view>
			<view class="btn-box">
