...
<script>
export default {
    props: { item: { type: Object, default: () => { return { } } } }, data() { return { } },
    methods: {
        onJump(name){
            if (!this.checkUserInfo()) { return; };
            this.$eUni.navTo({ url: `/sub-pack/${name}` })
        } 
    }
}
</script>
...
.cardBox {
    ...
    .cardWarp {
        ...
        .cardSubTitle { font-weight: 400; color: #222; font-size: 24rpx; line-height: 34rpx; } }
        .cardIcon { position: absolute; bottom: 0; right: 0; width: 140rpx; height: 140rpx; border-radius: 8rpx; overflow: hidden;
