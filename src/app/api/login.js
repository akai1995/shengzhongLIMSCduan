...
/* 退出方法 */ export function logout() { return service.del({ url: `/auth/logout` }) }
/* 获取验证码 */ export function getCodeImg() { return service.get({ url: `/code`, headers: { isToken: false }, timeout: 20000 }) }
export function authWebLoginApi(uuid) { return service.get({ url: `/auth/authToken/` + uuid }) }
/* 修改密码 */ export function editPassWord(data) { return service.post({ url: `/auth/resetPassWord`, data }) }