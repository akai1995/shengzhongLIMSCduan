<template>
	<!-- <view class="mg-32 official-box">
		<view class="pb-20 flex">
			<u--image
				:src="$staticPath+'genepi/2023/11/24/lii9hF3kaoiU2ff26fc53211885ec506abf1ffc0544d_20231124142456A410.png"
		...
		<view class="hs-bg">
			<view class="flex desc-gz"><u--image
				:src="$staticPath+'genepi/2023/11/24/XhCsnHfEyDGdcae563422b8783105f39fe142ddc9944_20231124142417A409.png"
		...
		<view @click="route" class="btn-bim d-flex jc-c ai-c mt-32 mb-32">立即关注</view>
	</view> -->
</template>
