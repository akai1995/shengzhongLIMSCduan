...
<script>
	export default {
		...
		data() {
			return {
				icon:this.$staticPath+'genepi/2023/11/20/viJafsIMIXkA73c2a80b68df31d0d0530e72926de14a_20231120111723A422.png',
				src: '',
				img:this.$staticPath+'genepi/2023/11/24/Mask group@2x_20231124181155A412.png'
			};
		},
		methods: {
            routeChat (item) {
