...
<script>
         ...
         * @property {Boolean} mask-click-able 遮罩是否可点击，为false时点击不会触发click事件（默认true）
         * @event {Function} click mask-click-able为true时，点击遮罩触发此事件
        ...
        export default {
                ...
                watch: {
                        show(n) {
                                if (n && this.zoom) {
                                        // 当显示遮罩的时候，设置scale为1，达到缩小（原来为1.2）的效果
