        ...
        <view class="detail">
            ...
            <view class="detail-content">
                ...
                <view class="detail-date">
                    ...
                    <view class="detail-date-has-list" v-if="deviceInfo.reserveTime && deviceInfo.reserveTime.length > 0">
                        <view class="detail-date-has-item" v-for="item in deviceInfo.reserveTime">{{ `${item.reserveStartTime} - ${item.reserveEndTime}` }}</view>
                    </view>
                    <view v-if="choose.moreText" class="detail-date-more-list" @click="handleClickMoreText">查看更多</view>
                    <view class="detail-date-has-box" v-if="deviceInfo.reserveTime && deviceInfo.reserveTime.length == 0">
